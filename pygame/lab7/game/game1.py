...
pygame.display.set_caption("Existencial Crisis")

radius_of_ball = 25

x_plane = (screen_width - radius_of_ball * 2) // 2#starting points for ball
...
while process:
    ...
    pygame.draw.circle(screen, "red" , (x_plane, y_plane), radius_of_ball)
